...
export const Pendapatan: FC = () => {
  const [currentData, setCurrentData] = useState<any>(DUMMY_DATA["oneDay"])
  return (
    <div className="font-sans">
      <h2 className="font-bold text-2xl text-black">Pendapatan Toko</h2>
      <div className="rounded-3xl p-4 bg-white mt-5">
        <h3 className="text-center font-bold text-xl mb-2">Pendapatan Total</h3>
        <IntervalTabs
